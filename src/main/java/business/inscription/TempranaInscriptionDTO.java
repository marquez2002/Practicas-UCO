...
/**
 * Clase que implementa el creador de inscripciones tempranas para un campamento.
 * Extiende la clase InscriptionDTOCreation y proporciona implementaciones de los 
 * métodos RegistrationCompleta y RegistrationParcial para crear inscripciones.
 * 
 ...
 * @version 1.0
 */
public class TempranaInscriptionDTO extends InscriptionDTOCreation {

    /**
     * Crea una inscripción completa para un participante en un campamento con precio temprano.
     *
     ...
     * @param price El precio de la inscripción temprana.
    ...
    public InscriptionDTO RegistrationCompleta(int idAsistent, int idCamp, Date inscriptionDate, float price, Boolean completada) {
        ...
        inscription.setCancelada(false); // Cambiado a false para inscripciones tempranas
        inscription.setCompletada(completada);
        return inscription;
    }

    /**
     * Crea una inscripción parcial para un participante en un campamento con precio temprano.
     *
     * @param idAsistent El identificador del participante.
     * @param idCamp El identificador del campamento.
     * @param inscriptionDate La fecha en la que se realiza la inscripción.
